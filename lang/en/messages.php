...
return [
    ...
    'influencer' => [
        'form_title' => 'Become an Influencer',
        'form_subtitle' => 'Share your details and social media accounts with us',
        'section_personal' => 'Personal Information',
        'section_social' => 'Social Media Accounts',
        'section_additional' => 'Additional Information',
        'social_hint' => 'Enter at least one social media account',
        'followers' => 'Followers',
        ...
        'portfolio' => 'About You (Optional)',
        'portfolio_placeholder' => 'Tell us about yourself and the content you create...',
        'submit' => 'Submit Application',
        'success_title' => 'Application Submitted!',
        'success_message' => 'We will review your application and contact you soon.',
        'already_applied_title' => 'You Have Already Applied',
        'already_applied_message' => 'Your application is under review. We will contact you soon.',
        'at_least_one_social' => 'Please enter at least one social media account',
    ],

    // Partners Dashboard
    'partners' => [
        'login' => [
            'heading' => 'Partners Portal',
            'subheading' => 'Log in to access your dashboard',
            'email' => 'Email',
            'password' => 'Password',
        ],
        'nav' => [
        ...
        'dashboard' => [
            'title' => 'Dashboard',
            'partner' => 'Partner',
            'influencer_role' => 'Affiliate Marketer',
            'greeting' => 'Hello :name! 👋',
            'welcome_message' => 'Welcome to Partners Dashboard',
            'overview' => 'Overview',
            ...
            'monthly_goal' => 'Monthly Goal: :count orders',
            'growth_from_last_month' => 'from last month',
            'your_codes' => 'Your Discount Codes',
            'discount_for_followers' => 'discount for your followers',
            'code_copied' => 'Code copied!',
            'copy' => 'Copy',
            'no_codes' => 'No discount codes available',
            ...
            'share_code_hint' => 'Share your discount code with followers to start earning commissions!',
        ],
    ],
