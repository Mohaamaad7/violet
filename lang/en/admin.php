...
return [
    ...
    'pages' => [
        ...
        'analytics_settings' => [
            ...
            'frontend_tracking' => 'Frontend Tracking',
            'frontend_tracking_desc' => 'Used to track store visitors on the frontend interface.',
            'tracking_id' => 'Tracking ID (Measurement ID)',
            'tracking_id_help' => 'Your Google Analytics 4 Tracking ID.',
            'backend_api' => 'Backend Analytics API',
            'backend_api_desc' => 'Used to fetch and display statistics within this dashboard.',
            'property_id' => 'Property ID',
            'property_id_help' => 'Your Google Analytics Property ID.',
            'service_account_json' => 'Service Account Credentials (JSON)',
            'service_account_json_help' => 'Upload the Service Account JSON file to securely connect the dashboard to Google API.',
        ],
        'analytics_dashboard' => [
