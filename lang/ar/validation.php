...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => ':attribute يجب أن يكون طوله بين :min و :max حرف.',
    ],
    ...
    'digits' => ':attribute يجب أن يتكون من :digits رقم.',
    'digits_between' => ':attribute يجب أن يتكون من :min إلى :max رقم.',
    'dimensions' => ':attribute له أبعاد صورة غير صالحة.',
    'distinct' => ':attribute له قيمة مكررة.',
    'doesnt_end_with' => ':attribute يجب ألا ينتهي بأحد التالي: :values.',
    'doesnt_start_with' => ':attribute يجب ألا يبدأ بأحد التالي: :values.',
    'email' => ':attribute يجب أن يكون بريداً إلكترونياً صالحاً.',
    'ends_with' => ':attribute يجب أن ينتهي بأحد التالي: :values.',
    ...
    'missing_unless' => ':attribute يجب أن يكون مفقوداً إلا إذا كان :other هو :value.',
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            ...
            'regex' => 'رقم الهاتف يجب أن يتكون من 10-15 رقم.',
        ],
        'governorate' => [
        ...
        'address_details' => [
            ...
            'max' => 'تفاصيل العنوان يجب ألا تتجاوز 500 حرف.',
        ],
    ],
