...
return [
    ...
    'pages' => [
        ...
        'analytics_settings' => [
            ...
            'frontend_tracking' => 'إعدادات واجهة المتجر (Frontend Tracking)',
            'frontend_tracking_desc' => 'يستخدم لتتبع زوار المتجر في واجهة المستخدم.',
            'tracking_id' => 'Tracking ID (Measurement ID)',
            'tracking_id_help' => 'معرف التتبع الخاص بـ Google Analytics 4.',
            'backend_api' => 'إعدادات جلب البيانات (Backend Analytics API)',
            'backend_api_desc' => 'يستخدم لجلب وعرض الإحصائيات داخل لوحة التحكم هذه.',
            'property_id' => 'Property ID',
            'property_id_help' => 'رقم الـ Property الخاص بحسابك في Google Analytics.',
            'service_account_json' => 'Service Account Credentials (JSON)',
            'service_account_json_help' => 'يجب رفع ملف الـ JSON الخاص بـ Service Account لربط لوحة التحكم بـ API جوجل بشكل آمن.',
        ],
        'analytics_dashboard' => [
            'title' => 'لوحة الإحصائيات',
            'visitors' => 'الزوار (آخر 30 يوم)',
            'page_views' => 'المشاهدات',
            'bounce_rate' => 'معدل الارتداد',
            'avg_session' => 'متوسط مدة الجلسة',
            'top_countries' => 'أكثر الدول زيارة',
    ...
    'cache' => [
        'title' => 'مدير الكاش',
        'manage_cache' => 'إدارة الكاش',
        'description' => 'امسح البيانات المخبأة لتحديث الصور والملتيميديا ومحتوى الصفحات فوراً.',
        'clear_response' => 'مسح كاش الاستجابة',
        'clear_app' => 'مسح كاش التطبيق',
        'clear_blade' => 'مسح كاش القوالب',
        'clear_all' => 'مسح الكاش بالكامل',
        'response_cleared' => 'تم مسح كاش الاستجابة بنجاح',
        'app_cleared' => 'تم مسح كاش التطبيق بنجاح',
        'blade_cleared' => 'تم مسح كاش القوالب بنجاح',
        'all_cleared' => 'تم مسح جميع أنواع الكاش بنجاح',
        'failed' => 'فشل مسح الكاش',
        'current_driver' => 'إعدادات الكاش الحالية',
        'app_cache' => 'كاش التطبيق',
        'response_cache' => 'كاش الاستجابة',
        'lifetime' => 'مدة التخزين',
        'hours' => 'ساعة',
        'confirm_response' => 'هل أنت متأكد من مسح كاش الاستجابة؟',
        'confirm_app' => 'هل أنت متأكد من مسح كاش التطبيق؟',
        'confirm_blade' => 'هل أنت متأكد من مسح كاش القوالب؟',
        'confirm_all' => 'هل أنت متأكد؟ سيتم مسح جميع أنواع الكاش بما فيها كاش الاستجابة والتطبيق والقوالب والإعدادات والمسارات.',
    ],
