    ...
    public function run(): void
    {
        $entries = [
            ...
            [
                ...
                'answer' => '<p>لإنشاء نسخة احتياطية من النظام:</p>
                    <ol>
            ...
            [
                'category' => 'system',
                'question' => 'كيف أحذف النسخ الاحتياطية القديمة؟',
                'answer' => '<p>لإدارة النسخ الاحتياطية:</p>
            ...
            [
                'category' => 'system',
                'question' => 'ما هي صفحة إعادة تعيين النظام؟',
                'answer' => '<p><strong>⚠️ تحذير: هذه الميزة للسوبر أدمن فقط وتحذف البيانات نهائياً!</strong></p>
            ...
            [
                'category' => 'system',
                'question' => 'ما هي القوالب الجاهزة في إعادة التعيين؟',
                'answer' => '<p>توفر صفحة إعادة التعيين قوالب جاهزة لتسهيل الاختيار:</p>
                    <ul>
                        <li><strong>حذف كل البيانات (Factory Reset Lite):</strong>
                            <br>يحذف كل شيء ما عدا إعدادات النظام والموظفين</li>
                        <li><strong>وضع المطور:</strong>
                            <br>يحذف العملاء والطلبات فقط، ويُبقي المنتجات للاختبار</li>
                        <li><strong>الاحتفاظ بالمنتجات:</strong>
                            <br>يحذف كل شيء ما عدا المنتجات والفئات</li>
                    </ul>
