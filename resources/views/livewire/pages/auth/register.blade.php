...
new #[Layout('layouts.auth')] class extends Component {
    ...
    public function register(): void
    {
        ...
        // Create customer (NOT user - customers are separate table)
    ...
    <form wire:submit="register" class="space-y-5">
        ...
        <div>
            ...
            <x-text-input wire:model="phone" id="phone"
                class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-violet-500 focus:border-violet-500 transition-colors"
                type="tel" name="phone" autocomplete="tel" placeholder="{{ __('auth.phone_placeholder') }}" />
