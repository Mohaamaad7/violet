<div x-data="offersPage(@js($unifiedOffers))" class="min-h-screen bg-gray-50 pb-20">
    {{-- Hero Banner --}}
    ...
    {{-- Main Content --}}
    <div class="container mx-auto px-4 -mt-8 relative z-20" id="offers-grid">
            ...
            <template x-for="offer in visibleOffers" :key="offer.id">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col group">
                    ...
                    <div class="relative w-full pt-[100%] bg-gray-50 overflow-hidden">
                        <img :src="offer.image" :alt="offer.title" class="absolute inset-0 w-full h-full object-contain p-4 group-hover:scale-105 transition-transform duration-500">
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('offersPage', (initialOffers) => ({
