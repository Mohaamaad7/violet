                ...
                <div class="px-6 py-4 overflow-y-auto flex-1">
                    ...
                    <div class="mb-6 pb-6 border-b border-gray-200">
                        ...
                        <div class="relative">
                            ...
                            @else
                            <i class="fas fa-search absolute ltr:right-3 rtl:left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
                            @endif
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <div x-data="{ expanded: false }" class="mb-1">
                                ...
                                <div x-show="expanded" 
                                     ...
                                     x-transition:enter-end="opacity-100 translate-y-0"
                                     class="ltr:ml-8 rtl:mr-8 mt-1 space-y-1"
                                     style="display: none;"
                                >
                                    ...
                                    <div class="flex items-center gap-3 group py-1.5 px-2 rounded hover:bg-violet-50 transition-all duration-200">
                                        <div class="relative">
                                            <input 
                                                type="checkbox" 
                                                wire:click="toggleCategory({{ $childCategory->id }})"
                    ...
                    <div class="mb-6 pb-6 border-b border-gray-200">
                        ...
                        >
                            ...
                            <i class="fas fa-chevron-down text-gray-500 text-xs transition-transform duration-300"
                               :class="openBrands ? 'rotate-180' : ''"
                            ></i>
                        </button>
                        
                        <div x-show="openBrands"
                             x-transition:enter="transition ease-out duration-300"
                             x-transition:enter-start="opacity-0 -translate-y-2"
                             x-transition:enter-end="opacity-100 translate-y-0"
                        ...
                        >
                            ...
                            <label class="flex items-center gap-3 cursor-pointer group py-1.5 px-2 rounded hover:bg-violet-50 transition-all duration-200">
                                <input 
                                    type="checkbox" 
                                ...
                                >
                                <span class="text-sm text-gray-700 group-hover:text-violet-700 font-medium transition-colors duration-200">
                                    {{ $brand }}
                                </span>
                            </label>
                            @endforeach
                        ...
                        >
                            ...
                            <div class="bg-violet-50 border border-violet-200 rounded-lg p-3 flex items-center justify-center gap-2">
                                <span class="text-sm font-bold text-violet-800">
                                    ${{ number_format($minPrice !== '' ? $minPrice : $this->priceRange['min'], 0) }} - ${{ number_format($maxPrice !== '' ? $maxPrice : $this->priceRange['max'], 0) }}
                                </span>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="mb-6 pb-6 border-b border-gray-200">
                        ...
                        <div x-show="openSale"
                             ...
                             x-transition:enter-end="opacity-100 translate-y-0"
                        >
                            <label class="flex items-center gap-3 cursor-pointer group py-2 px-2 rounded hover:bg-violet-50 transition-all duration-200">
                                <div class="relative inline-flex items-center cursor-pointer">
                                    <input 
                                        ...
                                        class="sr-only peer"
                                    >
                                    <div class="w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-violet-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-violet-600"></div>
                                </div>
                                <span class="text-sm text-gray-700 group-hover:text-violet-700 font-medium transition-colors duration-200">
                        ...
                        >
                            ...
                            <label class="flex items-center gap-3 cursor-pointer group py-1.5 px-2 rounded hover:bg-violet-50 transition-all duration-200">
                                <input 
                                    ...
                                    class="w-4 h-4 text-violet-600 border-2 border-gray-400 focus:ring-2 focus:ring-violet-500 transition-all duration-200 cursor-pointer"
                                >
                                <span class="text-sm text-gray-700 group-hover:text-violet-700 font-medium transition-colors duration-200 flex items-center gap-2">
                        ...
                        >
                            ...
                            <label class="flex items-center gap-2 cursor-pointer group py-1.5 px-2 rounded hover:bg-violet-50 transition-all duration-200">
                                ...
                                <div class="flex items-center gap-1.5 flex-1">
                                    ...
                                    @endfor
                                    <span class="text-sm font-medium text-gray-800 group-hover:text-violet-700 ltr:ml-1 rtl:mr-1 transition-colors duration-200">
                                        {{ __('messages.and_up') }}
                                    </span>
                                </div>
                            </label>
            ...
            <div class="px-6 py-4 overflow-y-auto flex-1">
                    ...
                    <label class="flex items-center justify-between cursor-pointer py-2">
                        ...
                        <div class="relative inline-flex items-center cursor-pointer">
                            <input 
                                ...
                                class="sr-only peer"
                            >
                            <div class="w-11 h-6 bg-gray-300 peer-focus:ring-4 peer-focus:ring-violet-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-violet-600"></div>
                        </div>
                    </label>
                </div>
                ...
                <div class="mb-6 pb-6 border-b border-gray-200">
                    ...
                    <div x-show="openStock" class="space-y-2">
                        <label class="flex items-center gap-3 cursor-pointer py-1.5 px-2 rounded hover:bg-violet-50">
                            <input type="radio" wire:model.live="stockStatus" value="all" class="w-4 h-4 text-violet-600">
                            <span class="text-sm text-gray-700 font-medium">{{ __('messages.all_products') }}</span>
                        </label>
                        <label class="flex items-center gap-3 cursor-pointer py-1.5 px-2 rounded hover:bg-violet-50">
                            <input type="radio" wire:model.live="stockStatus" value="in_stock" class="w-4 h-4 text-violet-600">
                        ...
                        <label class="flex items-center gap-3 cursor-pointer py-1.5 px-2 rounded hover:bg-violet-50">
                            <input type="radio" wire:model.live="stockStatus" value="out_of_stock" class="w-4 h-4 text-violet-600">
                            <span class="text-sm text-gray-700 font-medium flex items-center gap-2">
                                <span class="w-2 h-2 bg-red-500 rounded-full"></span>
                                {{ __('messages.out_of_stock') }}
                            </span>
                ...
                <div class="mb-2">
                    ...
                    <div x-show="openRating" class="space-y-2">
                        ...
                        <label class="flex items-center gap-2 cursor-pointer py-1.5 px-2 rounded hover:bg-violet-50">
                            <input type="radio" wire:model.live="selectedRating" value="{{ $rating }}" class="w-4 h-4 text-violet-600">
                            <div class="flex items-center gap-1.5 flex-1">
                                @for($i = 1; $i <= 5; $i++)
                                <i class="fas fa-star text-sm {{ $i <= $rating ? 'text-yellow-400' : 'text-gray-300' }}"></i>
                                @endfor
                                <span class="text-sm font-medium text-gray-800 ltr:ml-1 rtl:mr-1">{{ __('messages.and_up') }}</span>
                            </div>
                        </label>
                        @endforeach
                        
                        @if($selectedRating)
                        <button wire:click="clearRating" class="text-xs text-violet-600 hover:text-violet-800 font-semibold mt-2 flex items-center gap-1">
                            <i class="fas fa-times text-xs"></i>
                            {{ __('messages.clear_rating') }}
                        </button>
                        @endif
        ...
        <div class="lg:col-span-9 relative" style="z-index: 1;">
            ...
            <div class="bg-violet-50 border border-violet-200 rounded-lg p-4 mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                    {{-- Search Filter Chip --}}
                    @if($search)
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-violet-300 rounded-full text-sm font-medium text-gray-800 shadow-sm">
                    ...
                    @foreach($selectedCategories as $categoryId)
                        ...
                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-violet-300 rounded-full text-sm font-medium text-gray-800 shadow-sm">
                            ...
                            {{ $category->name }}
                            <button wire:click="removeCategory({{ $categoryId }})" class="ltr:ml-1 rtl:mr-1 text-gray-500 hover:text-red-600">
                                <i class="fas fa-times text-xs"></i>
                            </button>
                        </span>
                        @endif
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-violet-300 rounded-full text-sm font-medium text-gray-800 shadow-sm">
                        ...
                        {{ $brand }}
                        <button wire:click="removeBrand('{{ $brand }}')" class="ltr:ml-1 rtl:mr-1 text-gray-500 hover:text-red-600">
                            <i class="fas fa-times text-xs"></i>
                        </button>
                    </span>
                    @endforeach
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-violet-300 rounded-full text-sm font-medium text-gray-800 shadow-sm">
                        ...
                        ${{ number_format($minPrice !== '' ? $minPrice : 0, 0) }} - ${{ number_format($maxPrice !== '' ? $maxPrice : 10000, 0) }}
                        <button wire:click="clearPriceFilter" class="ltr:ml-1 rtl:mr-1 text-gray-500 hover:text-red-600">
                            <i class="fas fa-times text-xs"></i>
                        </button>
                    </span>
                    @endif
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-violet-300 rounded-full text-sm font-medium text-gray-800 shadow-sm">
                        ...
                        {{ __('messages.on_sale') }}
                        <button wire:click="$set('onSaleOnly', false)" class="ltr:ml-1 rtl:mr-1 text-gray-500 hover:text-red-600">
                            <i class="fas fa-times text-xs"></i>
                        </button>
                    </span>
                    @endif
                    ...
                    <span class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-violet-300 rounded-full text-sm font-medium text-gray-800 shadow-sm">
                        ...
                        <button wire:click="$set('stockStatus', 'all')" class="ltr:ml-1 rtl:mr-1 text-gray-500 hover:text-red-600">
                            <i class="fas fa-times text-xs"></i>
                        </button>
                    </span>
                    @endif
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div class="flex items-center gap-3 w-full sm:w-auto">
                        ...
                        >
                            ...
                            @if($this->activeFiltersCount > 0)
                            <span class="ltr:ml-1 rtl:mr-1 px-2 py-0.5 bg-white text-violet-600 rounded-full text-xs font-bold">
                                {{ $this->activeFiltersCount }}
                            </span>
                            @endif
                        </button>
                        ...
                        <div class="text-sm text-gray-700 flex items-center gap-2">
                            ...
                            <span class="hidden sm:inline">
                                {{ __('messages.showing') }} <span class="font-bold text-gray-900">{{ $products->firstItem() ?? 0 }}</span> 
                                {{ __('messages.to') }} <span class="font-bold text-gray-900">{{ $products->lastItem() ?? 0 }}</span> 
                                {{ __('messages.of') }} <span class="font-bold text-violet-700">{{ $products->total() }}</span> {{ __('messages.products') }}
                            </span>
