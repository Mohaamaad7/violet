            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="w-full md:w-48">
                    ...
                    >
                        ...
                        <option value="pending">{{ __('messages.account.status.pending') }} ({{ $statusCounts['pending'] }})</option>
                        <option value="processing">{{ __('messages.account.status.processing') }} ({{ $statusCounts['processing'] }})</option>
                        <option value="shipped">{{ __('messages.account.status.shipped') }} ({{ $statusCounts['shipped'] }})</option>
                        <option value="delivered">{{ __('messages.account.status.delivered') }} ({{ $statusCounts['delivered'] }})</option>
                        <option value="cancelled">{{ __('messages.account.status.cancelled') }} ({{ $statusCounts['cancelled'] }})</option>
                    </select>
                </div>
