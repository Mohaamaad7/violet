                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="px-6 py-4 bg-gradient-to-r from-violet-600 to-violet-800 text-white">
                            <div class="flex items-center justify-between flex-row-reverse">
                                <!-- Count Badge -->
                                <span
                                    class="flex items-center justify-center w-14 h-14 rounded-full bg-white/20 text-white text-xl font-bold shadow-md">
                                    {{ $cartCount }}
                                    <span
                                        class="text-base font-normal ml-1">{{ $cartCount === 1 ? __('store.cart.product') : __('store.cart.products') }}</span>
                                </span>
                                <!-- Title and Icon -->
                                ...
                                @if($cart->items->count() > 1)
                                    <button wire:click="clearCart" wire:confirm="{{ __('store.cart.clear_cart_confirm') }}"
