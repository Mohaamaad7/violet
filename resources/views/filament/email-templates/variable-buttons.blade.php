...
>
    ...
    <div class="text-xs text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-700">
        <p class="flex items-start gap-2">
            ...
            <span>
                <strong>كيفية الاستخدام:</strong> انقر على أي متغير أعلاه لإدراجه مباشرة في المحرر عند موضع المؤشر.
                المتغيرات سيتم استبدالها بالقيم الفعلية عند إرسال البريد الإلكتروني.
            </span>
        </p>
    </div>
</div>
