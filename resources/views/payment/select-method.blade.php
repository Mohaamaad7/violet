    ...
    <div class="min-h-screen bg-gray-50 py-12" dir="rtl">
        <div class="max-w-2xl mx-auto px-4">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-gray-900">اختر طريقة الدفع</h1>
                <p class="text-gray-600 mt-2">الطلب رقم: {{ $order->order_number }}</p>
                <p class="text-xl font-semibold text-violet-600 mt-2">{{ number_format($order->total, 2) }} جنيه</p>
            </div>
            ...
            <form action="{{ route('payment.process', $order) }}" method="POST" id="payment-form">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    @if(count($paymentMethods) > 0)
                        <div class="p-4 border-b border-gray-100">
                            <h3 class="font-semibold text-gray-800 mb-4">الدفع الإلكتروني</h3>
                    ...
                    @if($codEnabled)
                        <div class="p-4">
                            <h3 class="font-semibold text-gray-800 mb-4">الدفع عند الاستلام</h3>
                            ...
                            <label
                                ...
                                <input type="radio" name="payment_method" value="cod"
                                    class="w-5 h-5 text-violet-600 border-gray-300 focus:ring-violet-500">
                                <div class="mr-4 flex-1">
                                    <span class="font-medium text-gray-900">الدفع نقداً عند الاستلام</span>
                                    <span class="text-sm text-gray-500 block">ادفع للمندوب عند استلام طلبك</span>
                                </div>
                ...
                <div class="mt-6">
                    <button type="submit" id="submit-btn"
                        ...
                        <span id="btn-text">متابعة الدفع</span>
