...
@endphp
<x-store-layout>
    <x-slot name="title">{{ $page->meta_title ?? __('contact.page_title') }}</x-slot>
    <x-slot name="description">{{ $page->meta_description ?? __('contact.meta_description') }}</x-slot>
    ...
    <div class="relative bg-gradient-to-br from-violet-600 via-violet-700 to-purple-800 text-white overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 text-center">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                {{ $page->metadata['hero_title'] ?? __('contact.hero.title') }}
            </h1>
            <p class="text-xl md:text-2xl text-violet-100 max-w-3xl mx-auto">
                {{ $page->metadata['hero_subtitle'] ?? __('contact.hero.subtitle') }}
            </p>
        </div>
    ...
    <div class="bg-gray-50 py-16 lg:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 lg:p-12">
                    <div class="flex items-center gap-3 mb-8">
                        ...
                        <h2 class="text-3xl lg:text-4xl font-bold text-gray-900">
                            {{ $page->metadata['contact_info_title'] ?? __('contact.contact_info.title') }}
                        </h2>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-gray-700 mb-3">
                                    <a href="tel:{{ preg_replace('/[^0-9\+]/', '', $contactSettings->phone) }}"
                                        class="text-violet-600 hover:text-violet-800 font-semibold">
                                        {{ $contactSettings->phone }}
                                    </a>
                                </p>
                                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $contactSettings->phone) }}?text=مرحباً، أريد الاستفسار عن منتجاتكم"
                                    target="_blank"
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-gray-700 leading-relaxed">
                                    {!! nl2br(e($page->metadata['working_hours_text'] ?? $contactSettings->working_hours)) !!}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 lg:p-12 mb-12">
                ...
                @php
                    $socials = collect($contactSettings->social_links)->keyBy(fn($item) => strtolower($item['platform'] ?? ''));
                @endphp
                ...
                <div class="flex justify-center gap-8 flex-wrap">
                    ...
                    <a href="{{ $socials['facebook']['url'] }}" target="_blank"
                        ...
                        <span class="font-semibold text-gray-700">{{ $socials['facebook']['platform'] ?? __('contact.social.facebook') }}</span>
                    </a>
                    @endif
                    ...
                    <a href="{{ $socials['instagram']['url'] }}" target="_blank"
                        ...
                        <span class="font-semibold text-gray-700">{{ $socials['instagram']['platform'] ?? __('contact.social.instagram') }}</span>
                    </a>
                    @endif

                    {{-- TikTok --}}
                    @if(isset($socials['tiktok']))
                    <a href="{{ $socials['tiktok']['url'] }}" target="_blank"
                        class="group flex flex-col items-center transition-transform duration-300 hover:-translate-y-2">
                        <div
                        ...
                        <span class="font-semibold text-gray-700">{{ $socials['tiktok']['platform'] ?? __('contact.social.tiktok') }}</span>
                    </a>
                    @endif
                </div>
            </div>
