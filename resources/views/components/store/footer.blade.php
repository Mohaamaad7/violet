        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div class="flex gap-2">
                        <div class="w-10 h-6 bg-white rounded flex items-center justify-center">
                            <svg class="w-6 h-4" viewBox="0 0 48 32" fill="none">
                                ...
                                <path d="M17.5 16L21.5 12L17.5 8" stroke="white" stroke-width="2" stroke-linecap="round"/>
                            </svg>
                        </div>
                        <div class="w-10 h-6 bg-white rounded flex items-center justify-center">
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    ...
                    <li>
                        <a href="/products" class="text-gray-400 hover:text-violet-400 transition text-sm flex items-center gap-1.5 group">
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <li>
                        <a href="/offers" class="text-gray-400 hover:text-violet-400 transition text-sm flex items-center gap-1.5 group">
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <li>
                        <a href="/contact" class="text-gray-400 hover:text-violet-400 transition text-sm flex items-center gap-1.5 group">
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <li>
                        <a href="/blog" class="text-gray-400 hover:text-violet-400 transition text-sm flex items-center gap-1.5 group">
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    ...
                    <li>
                        <a href="/shipping" class="text-gray-400 hover:text-violet-400 transition text-sm flex items-center gap-1.5 group">
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <li>
                        <a href="/returns" class="text-gray-400 hover:text-violet-400 transition text-sm flex items-center gap-1.5 group">
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
                    ...
                    <li>
                        <a href="/faq" class="text-gray-400 hover:text-violet-400 transition text-sm flex items-center gap-1.5 group">
                            <svg class="w-4 h-4 group-hover:translate-x-1 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                            </svg>
            ...
            <div>
                ...
                <div class="space-y-3 mb-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="mailto:support@violet.com" class="text-sm text-gray-400 hover:text-violet-400 transition">
                            support@violet.com
                        </a>
                    </div>
                    <div class="flex items-center gap-3">
