    ...
    <div class="p-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <button 
                ...
                disabled
                @endif
                class="flex-1 px-4 py-2 bg-violet-600 text-white rounded-lg font-semibold hover:bg-violet-700 transition disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
