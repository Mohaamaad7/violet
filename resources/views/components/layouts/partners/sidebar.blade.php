...
<aside id="sidebar" 
       class="fixed inset-y-0 {{ app()->getLocale() === 'ar' ? 'right-0' : 'left-0' }} w-64 h-screen bg-white dark:bg-gray-900 border-{{ app()->getLocale() === 'ar' ? 'l' : 'r' }} border-gray-200 dark:border-gray-700 shadow-lg lg:shadow-none overflow-y-auto z-50 lg:z-30"
